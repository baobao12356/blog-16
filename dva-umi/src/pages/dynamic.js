    ...
    upvote({ _id, upvote }) {
        ...
        dispatch({
            ...
            payload: {
                _id,
                upvote: upvote + 1,
                cb: result => result.success && this.setState(({ dynamicDetail }) => ({
                    dynamicDetail: {
                        ...dynamicDetail,
...
export default connect(({ dynamic, dialog, toast, loading, user }) => ({ dynamic, dialog, toast, loading, user }))(Dynamic)